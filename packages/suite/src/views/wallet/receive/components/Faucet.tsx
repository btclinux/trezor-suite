...
import { getCoinjoinUrl } from '@wallet-utils/coinjoinUtils';
...
const FAUCET_URL = getCoinjoinUrl();
...
export const startAutoBlockGen = () =>
    fetch(`${FAUCET_URL}start_generating_blocks_automatically`, {
        method: 'POST',
        body: 'interval_in_seconds=10',
    });

export const stopAutoBlockGen = () =>
    fetch(`${FAUCET_URL}stop_generating_blocks_automatically`, {
        method: 'POST',
    });

export const sendToAddress = (address: string, amount: string) =>
    fetch(`${FAUCET_URL}send_to_address`, {
        method: 'POST',
